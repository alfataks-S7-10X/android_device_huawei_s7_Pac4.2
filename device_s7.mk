...
PRODUCT_COPY_FILES += \
   ...
   device/huawei/s7/prebuilt/system//etc/wifi/rtecdc-mfgtest-bcm4329.bin:system/etc/wifi/rtecdc-mfgtest-bcm4329.bin \
    ...
    device/huawei/s7/prebuilt/system/bin/huawei_brcm_patchram_plus:system/bin/huawei_brcm_patchram_plus
...
xPRODUCT_COPY_FILES += \
    device/huawei/s7/prebuilt/system/bin/hciconfig:system/bin/hciconfig \
    device/huawei/s7/prebuilt/system/bin/hcitool:system/bin/hcitool
...
PRODUCT_COPY_FILES += \
    ...
    device/huawei/s7/prebuilt/system/app/scrnoff.apk:system/app/scrnoff.apk
